...
import { controllerCallUpdateBrandingPreference } from "./controllerCallUpdateBrandingPreference";
...
): Promise<BrandingPreference | null> {

    const res = (await commonControllerDecode(() => controllerCallUpdateBrandingPreference(
        session, brandingPreference), null) as BrandingPreference | null);

    return res;

}

export default controllerDecodeUpdateBrandingPrefrence;
