...
import { controllerCallGetBrandingPreference } from "./controllerCallGetBrandingPreference";
 ...
 */
export async function controllerDecodeGetBrandingPrefrence(session: Session): Promise<BrandingPreference | null> {
