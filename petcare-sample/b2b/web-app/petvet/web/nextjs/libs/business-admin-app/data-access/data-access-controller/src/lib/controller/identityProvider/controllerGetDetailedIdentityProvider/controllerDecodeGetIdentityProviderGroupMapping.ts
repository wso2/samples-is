...
import { controllerCallGetIdentityProviderGroupMappings } from "./controllerCallGetIdentityProviderGroupMappings";
 ...
 */
export async function controllerDecodeGetIdentityProviderGroupMappings(session: Session, id: string)
    : Promise<IdentityProviderGroupMappings | null> {

    const res = (await commonControllerDecode(() => controllerCallGetIdentityProviderGroupMappings(session, id),
...
export default controllerDecodeGetIdentityProviderGroupMappings;
