...
import { controllerCallRevertBrandingPreference } from "./controllerCallRevertBrandingPreference";
 ...
 */
export async function controllerDecodeRevertBrandingPreference(
    session: Session
...
export default controllerDecodeRevertBrandingPreference;
