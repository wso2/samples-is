...
service / on new http:Listener(9090) {
    ...
    resource function post start\-authentication(http:Caller caller, User user) {
        ...
        do {
            ...
            // In this example, username is validated back with Asgardeo to ensure it is a valid user.
            ...
            if asgardeoUser is error {
                log:printInfo(string `${contextId}: Error occurred while retrieving user from Asgardeo.`, 
                    asgardeoUser);
