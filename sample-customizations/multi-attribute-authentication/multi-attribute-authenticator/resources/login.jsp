...
<%!
    ...
    private static final boolean SHOW_LOGIN_CLAIM_OPTIONS = false;
    private static final String MULTI_ATTRIBUTE__AUTHENTICATOR = "MultiAttributeAuthenticator";
                    ...
                    <div class="boarder-all ">
                        ...
                        <div class="padding-double login-form">
                            ...
                            <%
                                    ...
                                    localAuthenticatorNames.contains(MULTI_ATTRIBUTE__AUTHENTICATOR)) {
                                hasLocalLoginOptions = true;
