...
echo "|               [ This will enable self sign-up in the IS without any  |"
echo "|               other configuration changes. But although you see the |"
echo "|               notification in UI, you will not get email.]          |"
echo "|                                                                     |"
