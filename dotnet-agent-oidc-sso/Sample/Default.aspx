...
font-weight: bold;">&nbsp;Your ever trusted guidience is now offered online!</h2>
         ...
         <%  Dictionary<String, String> Claims = (Dictionary<String, String>) HttpContext.Current.Session["claims"];
             ...
             if (Claims == null)
             { %>
                <p class="center-elem"><a href="oidcsso" class="btn btn-primary btn-lg"
                    style="font-family: Courier New;font-size: 27px;">Sign in &raquo;</a></p>
         <% }
            else
            { %>
                <p class="center-elem"><a href="oidclogout" class="btn btn-primary btn-lg"
                    style="font-family: Courier New;font-size: 27px;">Sign out &raquo;</a></p>
         <% } %>
    </div>
