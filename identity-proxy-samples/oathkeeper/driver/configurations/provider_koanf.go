...
func (v *KoanfProvider) SessionStoreIsEnabled() bool {
	return v.source.Exists("session_store")
}
...
func (v *KoanfProvider) SessionStoreConfig() (*session_store.StoreConfig, error) {
	...
	v.l.WithField("config_key", "session_store").Debug("Attempting to unmarshal session store config")
	if err := v.source.Unmarshal("session_store", &rawConfig); err != nil {
