...
@Component(
        name = "identity.post.authn.disclaimer.handler",
        immediate = true
)
public class DisclaimerPostAuthnHandlerServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            DisclaimerPostAuthenticationHandler disclaimerPostAuthenticationHandler =
                    new DisclaimerPostAuthenticationHandler();
